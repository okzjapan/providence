...
class KeibaDataLoader:
    ...
    def load_race_dataset(
        ...
        SELECT
            ...
            re.pace_index_pred,
            re.agari_index_pred,
            re.position_index_pred,
            re.pace_prediction,
            re.improvement_grade,
            re.upset_index,
            re.longshot_index,
            re.heavy_aptitude_code,
            re.hoof_code,
            re.blinkers,
            re.turf_aptitude_code,
            re.dirt_aptitude_code,
            re.start_index,
            re.delay_rate,
            re.stable_rank,
            rr.finish_position,
            ...
            rr.jrdb_idm AS jrdb_idm_post,
            rr.base_score,
            rr.track_bias,
            rr.pace_factor,
            rr.late_start_correction,
            rr.positioning_correction,
            rr.disadvantage_correction,
            rr.course_position,
            rr.ten_index AS ten_index_actual,
            rr.agari_index AS agari_index_actual,
            rr.pace_index AS pace_index_actual,
            rr.body_weight,
